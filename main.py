...
# ASSIGNING IMAGES FROM ASSETS FOLDER TO VARIABLES
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    copyright_text = COPYRIGHT_FONT.render("©2021 Zack Dellarocco", 1, WHITE)
    ...
    WIN.blit(copyright_text, (10, HEIGHT - copyright_text.get_height() - 5))
...
def yellow_input(keys_pressed, yellow):
...
def red_input(keys_pressed, red):
...
def main():
    ...
    while run:
        ...
        yellow_input(keys_pressed, yellow)

        red_input(keys_pressed, red)
